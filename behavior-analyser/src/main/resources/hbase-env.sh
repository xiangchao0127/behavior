...
#
export HBASE_REGIONSERVER_OPTS="  -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false"
# If you want to configure BucketCache, specify '-XX: MaxDirectMemorySize=' with proper direct memory size

export HBASE_REGIONSERVER_OPTS="$HBASE_REGIONSERVER_OPTS  -Dcom.sun.management.jmxremote.port=10103"
