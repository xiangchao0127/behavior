package com.handge.bigdata.pools.jdbc;


import com.handge.bigdata.pools.common.ConnectionException;
import com.handge.bigdata.pools.common.ConnectionFactory;
...
class JdbcConnectionFactory implements ConnectionFactory<Connection> {
    ...
    public JdbcConnectionFactory(final String driverClass, final String jdbcUrl, final String username, final String password) {
        ...
        this.driverClass = (driverClass == null || driverClass.isEmpty()) ? "com.mysql.jdbc.Driver" : driverClass;
